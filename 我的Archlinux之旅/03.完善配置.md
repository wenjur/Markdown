...
主要内容有[Bluetooth](#Bluetooth)，[CPU](#CPU)，[风扇](#风扇)，[显示](#显示)，[Network](#Network)
...
## 触摸板
目前的触摸板部分手势操作不支持，比如轻触、双指轻触，kde的触摸板设置中二者选项是灰色的也可印证，libinput可以解决这一问题。

参考：[libinput - ArchWiki](https://wiki.archlinux.org/title/Libinput)
